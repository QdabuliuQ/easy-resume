...
function Global() {
  ...
  const headerStyleOptions = useMemo(
    () => [
      ...
      { value: 11, label: tg('style11') },
      { value: 12, label: tg('style12') },
      { value: 13, label: tg('style13') },
      { value: 14, label: tg('style14') },
      { value: 15, label: tg('style15') },
      { value: 16, label: tg('style16') },
      { value: 17, label: tg('style17') },
      { value: 18, label: tg('style18') },
      { value: 19, label: tg('style19') },
      { value: 20, label: tg('style20') },
      { value: 21, label: tg('style21') },
      { value: 22, label: tg('style22') },
      { value: 23, label: tg('style23') },
      { value: 24, label: tg('style24') },
      { value: 25, label: tg('style25') },
      { value: 26, label: tg('style26') },
    ],
    [tg],
  );
